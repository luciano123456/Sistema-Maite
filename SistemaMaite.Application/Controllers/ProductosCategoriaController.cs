...
namespace SistemaMaite.Application.Controllers
{
    ...
    public class ProductosCategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Lista()
        {
            ...
            var lista = ProductosCategoria.Select(c => new VMGenericModel
            {
                Id = c.Id,
                Nombre = c.Nombre,
            }).ToList();
        ...
        {
            var result = new ProductosCategoria
            {
                Id = model.Id,
                Nombre = model.Nombre,
            };

            bool respuesta = await _ProductosCategoriaService.Insertar(result);
        ...
        public async Task<IActionResult> Actualizar([FromBody] VMGenericModel model)
        {
            ...
            bool respuesta = await _ProductosCategoriaService.Actualizar(result);
        ...
        {
             var result = await _ProductosCategoriaService.Obtener(id);
